...
document.querySelectorAll('.tab-menu-partituras a').forEach(tab => {
  ...
  <!-- SCRIPT PARA ACTIVAR EL MENÚ LATERAL (Scroll Horizontal de Secciones) -->
  ...
  <!-- SCRIPT PARA MANEJAR LAS PESTAÑAS DE VIDEOS -->
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Asegúrate de que el audio comience en silencio
  audio.muted = true;

  // Actualiza el texto del botón según el estado inicial
  toggleButton.textContent = audio.muted ? '🔇 Encender' : '🔊 Apagar';

  // Maneja el botón de encendido/apagado
